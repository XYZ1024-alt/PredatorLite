...
.\build\test-store-package.ps1 `
  -PackagePath publish\store\PredatorLite-Store-1.1.1-win-x64.msixupload `
  -ExpectedVersion 1.1.1.0
```

The result is:

- `publish\store\PredatorLite-Store-1.1.1-win-x64.msixupload`;
- `publish\store\PredatorLite-Store-1.1.1-win-x64.msixupload.sha256`.
