...
public sealed class HardwareWritePolicyTests
{
    ...
    [InlineData("Lenovo", "Predator PHN16-71", "V1.20", true, true, HardwareWriteBlockReason.UnsupportedTargetProfile)]
    [InlineData("Acer", "Predator PHN16-72", "V1.20", true, true, HardwareWriteBlockReason.UnsupportedTargetProfile)]
    [InlineData("Acer", "Predator PHN16-71", "V1.21", true, true, HardwareWriteBlockReason.UnsupportedTargetProfile)]
